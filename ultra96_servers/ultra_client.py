...
#====================================================================================================================================================================
def threaded_client(ser_addr, ser_port, secret_key, database):
...
def connect_to_mongodb():
    ...
    try:
        client = pymongo.MongoClient("mongodb+srv://hafidz:hafidz@cluster0.7p6mm.gcp.mongodb.net/test?retryWrites=true&w=majority")
    except:
        return -1
    else:
