...
def connect_to_mongodb():
    ...
    try:
        client = pymongo.MongoClient("mongodb+srv://hafidz:hafidz@cluster0.7p6mm.gcp.mongodb.net/test2?retryWrites=true&w=majority")
    except:
...
def data_to_send(data):
    try:
        ...
        data = {"index": index1, "dancerId": dancer_id1, "move": action1, "position": int(position1), "eventDate": datetime.fromtimestamp(int(time.time()))}
